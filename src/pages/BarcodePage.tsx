      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex w-1/2 flex-col overflow-hidden border-r border-slate-200">
          <div className="border-b border-slate-200 bg-white px-4 py-3">
            ...
            <p className="mt-1 text-[11px] text-slate-400">Barkodu okutunca ürün otomatik olarak etiket listesine eklenir.</p>
          </div>
        ...
        <BarcodeScanner
          onDetected={(code) => {
            ...
            if (match) {
              ...
              window.alert(`Bu barkoda kayıtlı ürün bulunamadı: ${code}`);
            }
          }}
